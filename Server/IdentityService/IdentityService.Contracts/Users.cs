...
namespace Catalog.IdentityService.Contracts;
...
public record GetUserResponse(string UserId, string FirstName, string LastName, string? DisplayName, string Email);