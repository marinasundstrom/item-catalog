...
class SearchContext : DbContext, ISearchContext
{
    ...
    public SearchContext(
        DbContextOptions<SearchContext> options,
...
#nullable restore
    ...
    class Transaction : ITransaction
    {
        ...
        public Transaction(SearchContext context, IDbContextTransaction transaction)
        {
            _context = context;
